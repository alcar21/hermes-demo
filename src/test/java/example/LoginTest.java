...
import es.indra.kubernetes.demo.Login;
...
public class LoginTest extends ConfigTest {
  ...
  public void FIXME_testLoginConfig() throws Exception {
    ActionConfig config = assertClass("es.indra.kubernetes.demo", "Login_input", "es.indra.kubernetes.demo.Login");
    assertResult(config, ActionSupport.SUCCESS, "Menu");
    assertResult(config, ActionSupport.INPUT, "/es.indra.kubernetes.demo/Login.jsp");
  }
